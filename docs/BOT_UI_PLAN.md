...
> **Проверка 2026-07-10:** обновление от 2026-05-24 и protocol blocks 4–7 ближе к текущему коду, чем ограничения/«planned extensions» ранних разделов. Использовать документ как сочетание журнала и плана; current field/runtime readiness по одному наличию UI не подтверждена.
