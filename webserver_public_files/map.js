...
// Compose the visible map from one stable native tile level instead of
// switching to a different screenshot pyramid at every Leaflet zoom.  This
// avoids visible lighting/LOD jumps between neighbouring map tiles while the
// finer tile pyramid is still being regenerated by the screenshot bot.
const tileVersion = '20260623-stable2-metasiberia';
...
function loadTileImage(x, y, z) {
    ...
    const promise = new Promise(function (resolve, reject) {
        ...
        image.onerror = function () { reject(new Error('tile not ready')); };
        image.src = tileURLForCoords(x, y, z);
    });
