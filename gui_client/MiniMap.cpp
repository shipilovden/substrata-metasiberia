	...
	fullscreen(false)
{
	...
	arrow_image->setPosAndDims(minimap_botleft + minimap_dims * 0.5f, Vec2f(0.005f));
...

	{
		...
		fullscreen_button = new GLUIButton(*gl_ui, opengl_engine, gui_client->resources_dir_path + "/buttons/right_tab.png", args);
