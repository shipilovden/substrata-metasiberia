...
#if EMSCRIPTEN || USE_SDL // Show login, signup and avatar buttons on web and SDL
...
#endif
#ifdef CUSTOM_BUILD
		avatar_button = new GLUIButton(*gl_ui_, opengl_engine_, gui_client->resources_dir_path + "/buttons/shki-nvkz_avatar.png", Vec2f(0.f), /*dims=*/Vec2f(0.4f, 0.1f), args);
#else
