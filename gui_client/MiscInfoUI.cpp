...
void MiscInfoUI::showLoggedInButton(const std::string& username)
{
    ...
    logged_in_button_args.tooltip = QObject::tr("View user account");
	logged_in_button_args.font_size_px = 12;
    logged_in_button = new GLUITextButton(*gl_ui, opengl_engine, (QObject::tr("Logged in as ") + username).c_str(), Vec2f(0.f), logged_in_button_args);
