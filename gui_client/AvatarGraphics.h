...
public:
	...
	void setPendingGesture(const std::string& gesture_name, bool animate_head, bool loop_anim, double start_global_time)
	{
		setPendingGesture(gesture_name, /*gesture_anim_URL=*/URLString(), animate_head, loop_anim, start_global_time);
	}
