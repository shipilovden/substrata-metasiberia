...
{
	if(params.barkTextureType.size() == 7 && params.barkTextureType.substr(0, 4) == "Bark")
		return params.barkTextureType + "_1K-JPG";
	return "Bark001_1K-JPG";
}


std::string barkPrefixForParams(const TreeParams& params)
{
	return barkFolderForParams(params);
}
